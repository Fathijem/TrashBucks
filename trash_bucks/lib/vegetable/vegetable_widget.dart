...
export 'vegetable_model.dart';

class VegetableWidget extends StatefulWidget {
  const VegetableWidget({Key? key}) : super(key: key);

  @override
  _VegetableWidgetState createState() => _VegetableWidgetState();
}

class _VegetableWidgetState extends State<VegetableWidget> {
  late VegetableModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VegetableModel());
  }
